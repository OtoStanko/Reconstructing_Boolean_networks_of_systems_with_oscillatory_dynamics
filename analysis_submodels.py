...
gc_submodels_paths = [
    ...
    os.path.join(gc_model, "SketchBook", "reduced_submodel", "sat_networks_1", "candidate_rebuild.aeon"),
    os.path.join(gc_model, "SketchBook", "reduced_submodel", "sat_networks_1", "candidate_rebuild_trying_adjustments.aeon"),]
